...
const shoeImage = document.querySelector(
  "main section:nth-of-type(4) ul > li:nth-of-type(2) a img:first-of-type"
);
const shoeChange2 = document.querySelector(
  "main section:nth-of-type(4) ul > li:nth-of-type(2) ul li:nth-of-type(2) button"
);
const shoeChange1 = document.querySelector(
  "main section:nth-of-type(4) ul > li:nth-of-type(2) ul li:nth-of-type(1) button"
);
